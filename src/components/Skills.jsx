                  ...
                  {cat.skills.map((skill, sIdx) => (
                    <div key={sIdx} className="space-y-1.5">
                      <div className="flex justify-between items-center text-[11px] gap-3">
                        ...
                        <span className="w-[75px] text-center flex-shrink-0 text-[9px] text-zinc-400 font-medium py-1 px-1.5 rounded bg-zinc-800/50 border border-zinc-800 select-none whitespace-normal leading-tight flex items-center justify-center">
                          {skill.level}
                        </span>
                      </div>
